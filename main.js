...
var randNum = Math.floor((Math.random() * quick_draw_data_set.length) + 1);
var randSketch = quick_draw_data_set[randNum];
console.log(randSketch);
document.getElementById("sketchToBeDrawn").innerHTML = 'Sketch to be drawn: ' + randSketch;
var timerCounter = 0;
var timerCheck = '';
var drawnSketch = '';
var answerHolder = '';
...
function check_sketch() {
    ...
    if (timerCounter > 500) {
        timerCounter = 0;
        if (timerCheck == 'set' || answerHolder == 'set') {
            timerCheck = '';
            answerHolder = '';
            updateCanvas();
        }
...
function updateCanvas() {
    background("white");
    randNum = Math.floor((Math.random() * quick_draw_data_set.length) + 1);
    randSketch = quick_draw_data_set[randNum];
    console.log(randSketch);
    document.getElementById("sketchToBeDrawn").innerHTML = 'Sketch to be drawn: ' + randSketch;
}
